 ...
 * ``Converter`` and ``Storage`` implementations. To get it working implement
 ...
 * ```bash
 * phpunit src/EzSystems/TweetFieldTypeBundle/Tests/eZ/Publish/FieldType/TweetSPIIntegrationTest.php
 * ```
 *
 * @group integration
 */
